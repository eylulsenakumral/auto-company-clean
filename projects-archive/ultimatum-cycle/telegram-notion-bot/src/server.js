...
app.post('/webhook', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var webhookSecret, expectedSecret, error_1;
        ...
        switch (_a.label) {
            case 0:
                ...
                if (webhookSecret ! expectedSecret) {
                    logger_1.logger.warn('Unauthorized webhook attempt', {
                        ip: req.ip,
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, bot_1.default.handleUpdate(req.body)];
            case 2:
                _a.sent();
                res.sendStatus(200);
                return [3 /*break*/, 4];
            case 3:
                error_1  _a.sent();
                logger_1.logger.error('Webhook handling failed', {
...
app.listen(port, function () {
    ...
    logger_1.logger.info('Webhook mode enabled');
});
exports.default  app;
