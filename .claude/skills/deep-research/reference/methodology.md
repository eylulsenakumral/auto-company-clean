...
- Example: `WebSearch(query***REMOVED***"quantum computing 2025")`
...
- Example: `mcp__Exa__exa_search(query***REMOVED***"quantum computing", type***REMOVED***"neural", num_results***REMOVED***10)`
...
- WebSearch(query***REMOVED***"quantum computing 2025 state of the art")
- WebSearch(query***REMOVED***"quantum computing limitations challenges")
- WebSearch(query***REMOVED***"quantum computing commercial applications 2024-2025")
- WebSearch(query***REMOVED***"quantum computing vs classical comparison")
- WebSearch(query***REMOVED***"quantum error correction research", allowed_domains***REMOVED***["arxiv.org", "scholar.google.com"])
- Task(subagent_type***REMOVED***"general-purpose", description***REMOVED***"Analyze quantum computing papers", prompt***REMOVED***"Deep dive into quantum computing academic papers from 2024-2025, extract key findings and methodologies")
- Task(subagent_type***REMOVED***"general-purpose", description***REMOVED***"Industry analysis", prompt***REMOVED***"Analyze quantum computing industry reports and market data, identify commercial applications")
- Task(subagent_type***REMOVED***"general-purpose", description***REMOVED***"Technical challenges", prompt***REMOVED***"Extract technical limitations and challenges from quantum computing research")
```

**Example parallel execution (using Exa MCP - if available):**
```
[Single message with multiple tool calls]
- mcp__Exa__exa_search(query***REMOVED***"quantum computing state of the art", type***REMOVED***"neural", num_results***REMOVED***10, start_published_date***REMOVED***"2024-01-01")
- mcp__Exa__exa_search(query***REMOVED***"quantum computing limitations", type***REMOVED***"keyword", num_results***REMOVED***10)
- mcp__Exa__exa_search(query***REMOVED***"quantum computing commercial", type***REMOVED***"auto", num_results***REMOVED***10, start_published_date***REMOVED***"2024-01-01")
- mcp__Exa__exa_search(query***REMOVED***"quantum error correction", type***REMOVED***"neural", num_results***REMOVED***10, include_domains***REMOVED***["arxiv.org"])
- Task(subagent_type***REMOVED***"general-purpose", description***REMOVED***"Academic analysis", prompt***REMOVED***"Analyze quantum computing academic papers")
```
