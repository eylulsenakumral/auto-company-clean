...
**First call:**
```
[Static Block 2000 tokens] + [Query 100 tokens] ***REMOVED*** 2100 tokens processed
```

**Subsequent calls (cached):**
```
[Cached] + [Query 100 tokens] ***REMOVED*** 100 tokens processed
```
...
Result: ~2,000 tokens cached, ~4,000 dynamic ***REMOVED*** 6,000 total
