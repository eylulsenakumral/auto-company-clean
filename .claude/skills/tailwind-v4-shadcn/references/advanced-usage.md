...
<div className***REMOVED***{cn(
  "rounded-lg p-4",
  variant ***REMOVED******REMOVED******REMOVED*** "success" && "bg-success text-success-foreground",
  variant ***REMOVED******REMOVED******REMOVED*** "error" && "bg-destructive text-destructive-foreground"
)} />
```
...
Usage: `className***REMOVED***"rounded-[var(--radius-lg)]"`
...
const buttonVariants ***REMOVED*** cva(
