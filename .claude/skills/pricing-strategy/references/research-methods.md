...
- High utility ***REMOVED*** Must-have (include in base tier)
- Medium utility ***REMOVED*** Differentiator (use for tier separation)
- Low utility ***REMOVED*** Nice-to-have (premium tier or cut)
