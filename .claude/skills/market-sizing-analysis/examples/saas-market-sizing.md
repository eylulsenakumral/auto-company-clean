...
```
TAM ***REMOVED*** Σ (Segment Count × Annual Contract Value)
```

**Calculation:**

```
Small E-commerce:   85,000 × $3,600  ***REMOVED*** $306M
Mid-Market:         18,000 × $9,600  ***REMOVED*** $173M
Enterprise:          2,500 × $24,000 ***REMOVED*** $60M
                                      --------
...
- North America ***REMOVED*** 35% of global e-commerce market
- Global TAM ***REMOVED*** $539M / 0.35 ***REMOVED*** $1.54B

**TAM ***REMOVED*** $1.54B globally, $539M North America**
...
```
Small E-commerce:   $306M × 0.45 × 0.70 ***REMOVED*** $96M (57%)
Mid-Market:         $173M × 0.45 × 0.70 ***REMOVED*** $54M (32%)
Enterprise:         $60M × 0.45 × 0.70  ***REMOVED*** $19M (11%)
```
...
```
SOM (Year 3) ***REMOVED*** $169M × 2.5% ***REMOVED*** $4.2M ARR
SOM (Year 5) ***REMOVED*** $169M × 5.0% ***REMOVED*** $8.5M ARR
```

**SOM by Segment (Year 5):**

```
Small E-commerce:   $96M × 5% ***REMOVED*** $4.8M ARR (565 customers)
Mid-Market:         $54M × 5% ***REMOVED*** $2.7M ARR (281 customers)
Enterprise:         $19M × 5% ***REMOVED*** $1.0M ARR (42 customers)
                                --------
...
- North America ***REMOVED*** 40% of global software spending
- Email Marketing NA ***REMOVED*** $7.5B × 0.40 ***REMOVED*** $3.0B

### Step 3: Apply Segment Filters

**E-Commerce Focus:**

- E-commerce email marketing ***REMOVED*** 25% of total email marketing
- E-commerce segment ***REMOVED*** $3.0B × 0.25 ***REMOVED*** $750M

**$1M+ Revenue Filter:**

- Companies with $1M+ revenue ***REMOVED*** 65% of e-commerce market
- TAM ***REMOVED*** $750M × 0.65 ***REMOVED*** $488M

**AI-Powered Subset:**

- AI-powered email marketing ***REMOVED*** 35% of market (growing rapidly)
- SAM ***REMOVED*** $488M × 0.35 ***REMOVED*** $171M
