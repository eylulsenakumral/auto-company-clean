...
wrangler d1 execute my-db --file***REMOVED***schema.sql

# KV
wrangler kv:namespace create MY_KV
wrangler kv:key put --binding***REMOVED***MY_KV "key" "value"

# R2
wrangler r2 bucket create my-bucket
wrangler r2 object put my-bucket/file.txt --file***REMOVED***./file.txt
```

## Configuration (wrangler.toml)

```toml
name ***REMOVED*** "my-worker"
...
# R2 Bucket
[[r2_buckets]]
binding ***REMOVED*** "R2_BUCKET"
bucket_name ***REMOVED*** "my-bucket"

# Durable Objects
[[durable_objects.bindings]]
name ***REMOVED*** "COUNTER"
class_name ***REMOVED*** "Counter"
script_name ***REMOVED*** "my-worker"

# Queues
[[queues.producers]]
binding ***REMOVED*** "MY_QUEUE"
queue ***REMOVED*** "my-queue"
