...
kubectl get events -n <namespace> --sort-by***REMOVED***'.lastTimestamp'
...
| Problem | Command |
|---------|---------|
| Pod stuck | `kubectl delete pod <name> --grace-period***REMOVED***0 --force` |
| High CPU | `kubectl top pods -A --sort-by***REMOVED***cpu` |
| High memory | `kubectl top pods -A --sort-by***REMOVED***memory` |
