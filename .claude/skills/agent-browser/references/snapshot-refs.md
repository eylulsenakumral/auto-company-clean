...
@e7 [main]
  @e8 [h1] "Welcome"
  @e9 [form]
    @e10 [input type***REMOVED***"email"] placeholder***REMOVED***"Email"
    @e11 [input type***REMOVED***"password"] placeholder***REMOVED***"Password"
    @e12 [button type***REMOVED***"submit"] "Log In"
