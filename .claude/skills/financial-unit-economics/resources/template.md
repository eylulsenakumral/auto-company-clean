...
**Customer Acquisition Cost (CAC)** ***REMOVED*** Total acquisition costs ÷ New customers acquired
...
**CAC ***REMOVED*** $[Total Cost] ÷ [N customers] ***REMOVED*** $[CAC per customer]**
...
**Lifetime Value (LTV)** ***REMOVED*** Revenue over customer lifetime × Gross margin %
...
**Calculation**:
- **Customer Lifetime** ***REMOVED*** 1 ÷ Churn Rate ***REMOVED*** 1 ÷ [X]% ***REMOVED*** [Y] months
- **LTV** ***REMOVED*** $[ARPU] × [Y months] × [Gross Margin %] ***REMOVED*** **$[LTV]**
...
**Calculation**:
- **Annual Revenue per Customer** ***REMOVED*** $[AOV] × [Frequency] ***REMOVED*** $[X]/year
- **LTV** ***REMOVED*** $[Annual Revenue] × [Lifetime years] × [Gross Margin %] ***REMOVED*** **$[LTV]**
...
**Calculation**:
- **Monthly Revenue per User** ***REMOVED*** $[GMV] × [Take Rate] ***REMOVED*** $[X]/month
- **Customer Lifetime** ***REMOVED*** 1 ÷ [Churn] ***REMOVED*** [Y] months
- **LTV** ***REMOVED*** $[Monthly Rev] × [Lifetime] × [Gross Margin %] ***REMOVED*** **$[LTV]**
...
- **LTV** ***REMOVED*** ARPU × Gross Margin × Σ(retention %) ***REMOVED*** **$[X]**
...
- ARPU: $100/month
- Gross Margin: 80%
- Monthly Churn: 5% → Lifetime ***REMOVED*** 1/0.05 ***REMOVED*** 20 months
- **LTV** ***REMOVED*** $100 × 20 × 80% ***REMOVED*** **$1,600**

**Metrics**:
- **LTV/CAC**: $1,600 / $200 ***REMOVED*** **8:1** ✓ Excellent
- **Payback**: $200 ÷ ($100 × 80%) ***REMOVED*** **2.5 months** ✓ Excellent
