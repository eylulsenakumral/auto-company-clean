...
|--------|---------|
| **Volume** | Raw number |
| **Intent Score** | Info***REMOVED***1, Commercial***REMOVED***3, Transactional***REMOVED***5 |
| **Click Rate** | % of SERPs with organic clicks (check for zero-click) |
| **Difficulty** | 1-100 from tool |

Higher score ***REMOVED*** better opportunity.
...
- **Ignoring intent** — Ranking #1 for wrong intent ***REMOVED*** 90% bounce rate
