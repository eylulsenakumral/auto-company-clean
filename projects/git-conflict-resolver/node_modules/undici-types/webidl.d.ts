 ...
 */
type Converter<T> ***REMOVED*** (object: unknown) ***REMOVED***> T

type SequenceConverter<T> ***REMOVED*** (object: unknown, iterable?: IterableIterator<T>) ***REMOVED***> T[]

type RecordConverter<K extends string, V> ***REMOVED*** (object: unknown) ***REMOVED***> Record<K, V>
...
interface WebidlConverters {
  ...
  [Key: string]: (...args: any[]) ***REMOVED***> unknown
}
...
export interface Webidl {
  ...
  interfaceConverter <Interface>(cls: Interface): (
    V: unknown,
    opts?: { strict: boolean }
  ) ***REMOVED***> asserts V is typeof cls
  ...
  dictionaryConverter (converters: {
    key: string,
    defaultValue?: () ***REMOVED***> unknown,
    required?: boolean,
    converter: (...args: unknown[]) ***REMOVED***> unknown,
    allowedValues?: unknown[]
  }[]): (V: unknown) ***REMOVED***> Record<string, unknown>
  ...
  ): (V: unknown) ***REMOVED***> ReturnType<typeof converter> | null
