...
<p align***REMOVED***"center">
	<br>
	<img src***REMOVED***"screenshot.svg" width***REMOVED***"500">
	<br>
</p>
...
const spinner ***REMOVED*** ora('Loading unicorns').start();

setTimeout(() ***REMOVED***> {
	spinner.color ***REMOVED*** 'yellow';
	spinner.text ***REMOVED*** 'Loading rainbows';
}, 1000);
```
...
Type: `string | object`\
Default: `'dots'` <img src***REMOVED***"screenshot-spinner.gif" width***REMOVED***"14">
...
<img src***REMOVED***"screenshot-2.gif" width***REMOVED***"480">
...
Type: `Promise | ((spinner: ora.Ora) ***REMOVED***> Promise)`
...
Type: `string | ((result: T) ***REMOVED***> string) | undefined`
...
Type: `string | ((error: Error) ***REMOVED***> string) | undefined`
...
const spinner ***REMOVED*** ora(`Loading ${chalk.red('unicorns')}`).start();
```
