...
declare abstract class Iterator<T, TResult ***REMOVED*** undefined, TNext ***REMOVED*** unknown> { // eslint-disable-line @typescript-eslint/no-unsafe-declaration-merging
...
type IteratorObjectConstructor ***REMOVED*** typeof Iterator;
...
declare global {
    ...
    interface IteratorObject<T, TReturn, TNext> {
         ...
         */
        map<U>(callbackfn: (value: T, index: number) ***REMOVED***> U): IteratorObject<U, undefined, unknown>;
         ...
         */
        filter<S extends T>(predicate: (value: T, index: number) ***REMOVED***> value is S): IteratorObject<S, undefined, unknown>;

        /**
         * Creates an iterator whose values are those from this iterator for which the provided predicate returns true.
         * @param predicate A function that accepts up to two arguments to be used to test values from the underlying iterator.
         */
        filter(predicate: (value: T, index: number) ***REMOVED***> unknown): IteratorObject<T, undefined, unknown>;
         ...
         */
        flatMap<U>(callback: (value: T, index: number) ***REMOVED***> Iterator<U, unknown, undefined> | Iterable<U, unknown, undefined>): IteratorObject<U, undefined, unknown>;
         ...
         */
        reduce(callbackfn: (previousValue: T, currentValue: T, currentIndex: number) ***REMOVED***> T): T;
        reduce(callbackfn: (previousValue: T, currentValue: T, currentIndex: number) ***REMOVED***> T, initialValue: T): T;
         ...
         * @param initialValue If initialValue is specified, it is used as the initial value to start the accumulation. The first call to the callbackfn function provides this value as an argument instead of a value from the iterator.
         */
        reduce<U>(callbackfn: (previousValue: U, currentValue: T, currentIndex: number) ***REMOVED***> U, initialValue: U): U;
         ...
         */
        forEach(callbackfn: (value: T, index: number) ***REMOVED***> void): void;
         ...
         */
        some(predicate: (value: T, index: number) ***REMOVED***> unknown): boolean;
         ...
         */
        every(predicate: (value: T, index: number) ***REMOVED***> unknown): boolean;
         ...
         */
        find<S extends T>(predicate: (value: T, index: number) ***REMOVED***> value is S): S | undefined;
        find(predicate: (value: T, index: number) ***REMOVED***> unknown): T | undefined;
