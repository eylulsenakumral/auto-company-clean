 ...
 * } from 'node:fs';
 *
 * const gzip ***REMOVED*** createGzip();
 * const source ***REMOVED*** createReadStream('input.txt');
 * const destination ***REMOVED*** createWriteStream('input.txt.gz');
 *
 ...
 * const pipe ***REMOVED*** promisify(pipeline);
 *
 * async function do_gzip(input, output) {
 *   const gzip ***REMOVED*** createGzip();
 *   const source ***REMOVED*** createReadStream(input);
 *   const destination ***REMOVED*** createWriteStream(output);
 ...
 * });
 *
 * const buffer ***REMOVED*** Buffer.from('eJzT0yMAAGTvBe8***REMOVED***', 'base64');
 ...
 *
 * import { promisify } from 'node:util';
 * const do_unzip ***REMOVED*** promisify(unzip);
 *
 * do_unzip(buffer)
 *   .then((buf) ***REMOVED***> console.log(buf.toString()))
 *   .catch((err) ***REMOVED***> {
 *     console.error('An error occurred:', err);
 *     process.exitCode ***REMOVED*** 1;
 *   });
...
declare module "zlib" {
    ...
    interface Zlib {
        ...
        flush(kind?: number, callback?: () ***REMOVED***> void): void;
        flush(callback?: () ***REMOVED***> void): void;
    }
    interface ZlibParams {
        params(level: number, strategy: number, callback: () ***REMOVED***> void): void;
    }
    interface ZlibReset {
        reset(): void;
    }
     ...
     * since passing `windowBits ***REMOVED*** 9` to zlib actually results in a compressed stream
    ...
    type InputType ***REMOVED*** string | ArrayBuffer | NodeJS.ArrayBufferView;
    type CompressCallback ***REMOVED*** (error: Error | null, result: NonSharedBuffer) ***REMOVED***> void;
    /**
     * @since v11.7.0, v10.16.0
     */
