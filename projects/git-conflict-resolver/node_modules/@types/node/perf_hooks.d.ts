 ...
 *
 * const obs ***REMOVED*** new PerformanceObserver((items) ***REMOVED***> {
...
declare module "perf_hooks" {
     ...
     */
    type EventLoopUtilityFunction ***REMOVED*** (
        utilization1?: EventLoopUtilization,
        utilization2?: EventLoopUtilization,
    ) ***REMOVED***> EventLoopUtilization;
    ...
    interface Performance {
         ...
         * }
         *
         * const wrapped ***REMOVED*** performance.timerify(someFunction);
         *
         * const obs ***REMOVED*** new PerformanceObserver((list) ***REMOVED***> {
         ...
         * @param fn
         */
        timerify<T extends (...params: any[]) ***REMOVED***> any>(fn: T, options?: TimerifyOptions): T;
        /**
    ...
    class PerformanceObserverEntryList {
         ...
         * } from 'node:perf_hooks';
         *
         * const obs ***REMOVED*** new PerformanceObserver((perfObserverList, observer) ***REMOVED***> {
    ...
    type PerformanceObserverCallback ***REMOVED*** (list: PerformanceObserverEntryList, observer: PerformanceObserver) ***REMOVED***> void;
    /**
     * @since v8.5.0
     */
    class PerformanceObserver extends AsyncResource {
         ...
         * } from 'node:perf_hooks';
         *
         * const obs ***REMOVED*** new PerformanceObserver((list, observer) ***REMOVED***> {
         *   // Called once asynchronously. `list` contains three items.
         * });
         * obs.observe({ type: 'mark' });
         *
         * for (let n ***REMOVED*** 0; n < 3; n++)
     ...
     * const h ***REMOVED*** monitorEventLoopDelay({ resolution: 20 });
     * h.enable();
     * // Do something.
     * h.disable();
     * console.log(h.min);
