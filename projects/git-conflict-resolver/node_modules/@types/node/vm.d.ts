 ...
 *
 * const code ***REMOVED*** 'x +***REMOVED*** 40; var y ***REMOVED*** 17;';
...
declare module "vm" {
    ...
    type DynamicModuleLoader<T> ***REMOVED*** (
        specifier: string,
        referrer: T,
        importAttributes: ImportAttributes,
    ) ***REMOVED***> Module | Promise<Module>;
    ...
    type MeasureMemoryMode ***REMOVED*** "summary" | "detailed";
    ...
    class Script {
         ...
         * };
         *
         * const script ***REMOVED*** new vm.Script('count +***REMOVED*** 1; name ***REMOVED*** "kitty";');
         *
         * vm.createContext(context);
         * for (let i ***REMOVED*** 0; i < 10; ++i) {
         ...
         *
         * ```js
         * const vm ***REMOVED*** require('node:vm');
         *
         * const script ***REMOVED*** new vm.Script('globalVar ***REMOVED*** "set"');
         *
         * const contexts ***REMOVED*** [{}, {}, {}];
         ...
         * const freezeScript ***REMOVED*** new vm.Script('Object.freeze(globalThis); globalThis;');
         * const frozenContext ***REMOVED*** freezeScript.runInNewContext(vm.constants.DONT_CONTEXTIFY);
         * ```
         * @since v0.3.1
         ...
         * import vm from 'node:vm';
         *
         * global.globalVar ***REMOVED*** 0;
         *
         * const script ***REMOVED*** new vm.Script('globalVar +***REMOVED*** 1', { filename: 'myfile.vm' });
         *
         * for (let i ***REMOVED*** 0; i < 1000; ++i) {
         ...
         *
         * ```js
         * const script ***REMOVED*** new vm.Script(`
         * function add(a, b) {
         *   return a + b;
         * }
         *
         * const x ***REMOVED*** add(1, 2);
         * `);
         *
         * const cacheWithoutAdd ***REMOVED*** script.createCachedData();
         * // In `cacheWithoutAdd` the function `add()` is marked for full compilation
         * // upon invocation.
         *
         * script.runInThisContext();
         *
         * const cacheWithAdd ***REMOVED*** script.createCachedData();
         ...
         * const script ***REMOVED*** new vm.Script(`
         * function myFunc() {}
         * //# sourceMappingURL***REMOVED***sourcemap.json
         * `);
         *
     ...
     * const vm ***REMOVED*** require('node:vm');
     *
     * global.globalVar ***REMOVED*** 3;
     *
     * const context ***REMOVED*** { globalVar: 1 };
     * vm.createContext(context);
     *
     * vm.runInContext('globalVar ****REMOVED*** 2;', context);
     *
     * console.log(context);
     * // Prints: { globalVar: 2 }
     *
     ...
     *
     * for (let i ***REMOVED*** 0; i < 10; ++i) {
     *   vm.runInContext('globalVar ****REMOVED*** 2;', contextObject);
     * }
     ...
     * };
     *
     * vm.runInNewContext('count +***REMOVED*** 1; name ***REMOVED*** "kitty"', contextObject);
     * console.log(contextObject);
     ...
     * // can be frozen.
     * const frozenContext ***REMOVED*** vm.runInNewContext('Object.freeze(globalThis); globalThis;', vm.constants.DONT_CONTEXTIFY);
     * ```
     * @since v0.3.1
     * @param code The JavaScript code to compile and run.
     * @param contextObject Either `vm.constants.DONT_CONTEXTIFY` or an object that will be contextified.
     ...
     * ```js
     * import vm from 'node:vm';
     * let localVar ***REMOVED*** 'initial value';
     *
     * const vmResult ***REMOVED*** vm.runInThisContext('localVar ***REMOVED*** "vm";');
     * console.log(`vmResult: '${vmResult}', localVar: '${localVar}'`);
     * // Prints: vmResult: 'vm', localVar: 'initial value'
     *
     * const evalResult ***REMOVED*** eval('localVar ***REMOVED*** "eval";');
     ...
     * const code ***REMOVED*** `
     * ((require) ***REMOVED***> {
     *   const http ***REMOVED*** require('node:http');
     ...
     *   });
     *
     * const context ***REMOVED*** vm.createContext({ a: 1 });
    ...
    type ModuleStatus ***REMOVED*** "unlinked" | "linking" | "linked" | "evaluating" | "evaluated" | "errored";
    /**
     ...
     * import vm from 'node:vm';
     *
     * const contextifiedObject ***REMOVED*** vm.createContext({
     *   secret: 42,
     *   print: console.log,
     * });
     *
     ...
     *
     * const bar ***REMOVED*** new vm.SourceTextModule(`
     *   import s from 'foo';
     *   s;
     *   print(s);
     ...
     *   if (specifier ***REMOVED******REMOVED******REMOVED*** 'foo') {
    ...
    interface SourceTextModuleOptions extends Pick<ScriptOptions, "cachedData" | "columnOffset" | "lineOffset"> {
         ...
         */
        initializeImportMeta?: ((meta: ImportMeta, module: SourceTextModule) ***REMOVED***> void) | undefined;
        /**
         * Used to specify how the modules should be loaded during the evaluation of this script when `import()` is called. This option is
         * part of the experimental modules API. We do not recommend using it in a production environment. For detailed information, see
         * [Support of dynamic `import()` in compilation APIs](https://nodejs.org/docs/latest-v22.x/api/vm.html#support-of-dynamic-import-in-compilation-apis).
     ...
     * import vm from 'node:vm';
     *
     * const source ***REMOVED*** '{ "a": 1 }';
     * const module ***REMOVED*** new vm.SyntheticModule(['default'], function() {
     *   const obj ***REMOVED*** JSON.parse(source);
    ...
    class SyntheticModule extends Module {
        ...
        constructor(
            exportNames: string[],
            evaluateCallback: (this: SyntheticModule) ***REMOVED***> void,
         ...
         * import vm from 'node:vm';
         *
         * const m ***REMOVED*** new vm.SyntheticModule(['x'], () ***REMOVED***> {
         *   m.setExport('x', 1);
         * });
         *
