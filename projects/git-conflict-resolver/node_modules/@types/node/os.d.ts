...
declare module "os" {
    ...
    type NetworkInterfaceInfo ***REMOVED*** NetworkInterfaceInfoIPv4 | NetworkInterfaceInfoIPv6;
    /**
     ...
     * @since v10.10.0
     * @param [pid***REMOVED***0] The process ID to retrieve scheduling priority for.
     */
     ...
     * @since v10.10.0
     * @param [pid***REMOVED***0] The process ID to set scheduling priority for.
