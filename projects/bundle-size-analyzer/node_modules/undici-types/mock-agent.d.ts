...
import MockDispatch ***REMOVED*** MockInterceptor.MockDispatch;
...
declare class MockAgent<TMockAgentOptions extends MockAgent.Options ***REMOVED*** MockAgent.Options> extends Dispatcher {
  ...
  get<TInterceptable extends Interceptable>(origin: ((origin: string) ***REMOVED***> boolean)): TInterceptable;
  ...
  enableNetConnect(host: ((host: string) ***REMOVED***> boolean)): void;
