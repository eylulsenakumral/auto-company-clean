...
declare namespace RetryHandler {
  export type RetryState ***REMOVED*** { counter: number; };

  export type RetryContext ***REMOVED*** {
    state: RetryState;
  ...
  export type OnRetryCallback ***REMOVED*** (result?: Error | null) ***REMOVED***> void;

  export type RetryCallback ***REMOVED*** (
    err: Error,
    context: {
      state: RetryState;
      opts: Dispatcher.DispatchOptions & {
