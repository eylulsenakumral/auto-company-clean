 ...
 * const tracing ***REMOVED*** trace_events.createTracing({ categories: ['node.perf'] });
...
declare module "trace_events" {
    ...
    interface Tracing {
         ...
         * ```js
         * import trace_events from 'node:trace_events';
         * const t1 ***REMOVED*** trace_events.createTracing({ categories: ['node', 'v8'] });
         * const t2 ***REMOVED*** trace_events.createTracing({ categories: ['node.perf', 'node'] });
         * t1.enable();
         * t2.enable();
         *
     ...
     * ```js
     * import trace_events from 'node:trace_events';
     * const categories ***REMOVED*** ['node.perf', 'node.async_hooks'];
     * const tracing ***REMOVED*** trace_events.createTracing({ categories });
     * tracing.enable();
     * // do stuff
     * tracing.disable();
     * ```
     ...
     * ```js
     * import trace_events from 'node:trace_events';
     * const t1 ***REMOVED*** trace_events.createTracing({ categories: ['node.async_hooks'] });
     * const t2 ***REMOVED*** trace_events.createTracing({ categories: ['node.perf'] });
     * const t3 ***REMOVED*** trace_events.createTracing({ categories: ['v8'] });
     *
     * t1.enable();
     * t2.enable();
     *
