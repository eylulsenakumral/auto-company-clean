<h1 align***REMOVED***"center">
	<br>
	<br>
	<img width***REMOVED***"320" src***REMOVED***"media/logo.svg" alt***REMOVED***"Chalk">
	<br>
	<br>
	<br>
</h1>
...
[![npm dependents](https://badgen.net/npm/dependents/chalk)](https://www.npmjs.com/package/chalk?activeTab***REMOVED***dependents)
...
- [Why not switch to a smaller coloring package?](https://github.com/chalk/chalk?tab***REMOVED***readme-ov-file#why-not-switch-to-a-smaller-coloring-package)
...
const error ***REMOVED*** chalk.bold.red;
const warning ***REMOVED*** chalk.hex('#FFA500'); // Orange color
...
const name ***REMOVED*** 'Sindre';
console.log(chalk.green('Hello %s'), name);
//***REMOVED***> 'Hello Sindre'
```
...
const customChalk ***REMOVED*** new Chalk({level: 0});
```
...
Can be overridden by the user with the flags `--color` and `--no-color`. For situations where using `--color` is not possible, use the environment variable `FORCE_COLOR***REMOVED***1` (level 1), `FORCE_COLOR***REMOVED***2` (level 2), or `FORCE_COLOR***REMOVED***3` (level 3) to forcefully enable color, or `FORCE_COLOR***REMOVED***0` to forcefully disable. The use of `FORCE_COLOR` overrides all other color support checks.

Explicit 256/Truecolor mode can be enabled using the `--color***REMOVED***256` and `--color***REMOVED***16m` flags, respectively.
