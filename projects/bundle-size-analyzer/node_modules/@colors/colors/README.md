...
```js
var colors ***REMOVED*** require('@colors/colors');
...
```js
var colors ***REMOVED*** require('@colors/colors/safe');
...
node myapp.js --color***REMOVED***false

node myapp.js --color
node myapp.js --color***REMOVED***true
node myapp.js --color***REMOVED***always

FORCE_COLOR***REMOVED***1 node myapp.js
```
