 ...
 */
export function printAnalysis(analysis: BundleAnalysis, options: AnalyzerOptions ***REMOVED*** {}): void {
  if (options.json) {
  ...
  analysis.modules.forEach((module) ***REMOVED***> {
    ...
    const status ***REMOVED***
      category ***REMOVED******REMOVED******REMOVED*** 'red'
        ? chalk.red('⚠️ TOO BIG')
 ...
 */
export function printComparison(comparison: BundleComparison, options: AnalyzerOptions ***REMOVED*** {}): void {
  if (options.json) {
  ...
  const sizeText ***REMOVED***
    sizeChange >***REMOVED*** 0
 ...
 */
export function printBudget(result: BudgetResult, options: AnalyzerOptions ***REMOVED*** {}): void {
  if (options.json) {
 ...
 */
export function printBlame(blames: PackageBlame[], totalSize: number, options: AnalyzerOptions ***REMOVED*** {}): void {
  if (options.json) {
