import { BundleAnalysis, BundleComparison, ModuleChange, BundleModule } from './types.js';
import { parseBundle } from './analyzer.js';

/**
 * Compare two bundles and return differences
 */
export function compareBundles(oldPath: string, newPath: string): BundleComparison {
  ...
  const added: BundleModule[] ***REMOVED*** [];
  const removed: BundleModule[] ***REMOVED*** [];
  const changed: ModuleChange[] ***REMOVED*** [];
