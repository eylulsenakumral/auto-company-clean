 ...
 */
export function detectBundleFormat(filePath) {
 ...
 */
function simulateModuleBreakdown(content, format, totalSize) {
...
export function formatBytes(bytes) {
    if (bytes ***REMOVED******REMOVED******REMOVED*** 0)
        return '0 B';
 ...
 */
export function getSizeCategory(size, totalSize) {
