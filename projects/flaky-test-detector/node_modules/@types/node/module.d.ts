...
declare module "module" {
    ...
    namespace Module {
        ...
        namespace constants {
            ...
            namespace compileCacheStatus {
                 ...
                 * {@link enableCompileCache}, or by the `NODE_COMPILE_CACHE***REMOVED***dir`
                 ...
                 * `NODE_DISABLE_COMPILE_CACHE***REMOVED***1` has been set.
                 */
         ...
         * `NODE_COMPILE_CACHE***REMOVED***dir` environment variable if it's set, or use
         ...
         *     ├ bar/
         *       ├ bar.js
         *       └ package.json // name ***REMOVED*** '@foo/bar'
         *     └ qux/
         *       ├ node_modules/
         *         └ some-package/
         *           └ package.json // name ***REMOVED*** 'some-package'
         *       ├ qux.js
         *       └ package.json // name ***REMOVED*** '@foo/qux'
         *   ├ main.js
         *   └ package.json // name ***REMOVED*** '@foo'
         * ```
         * ```js
         ...
         */
        function register<Data ***REMOVED*** any>(
            specifier: string | URL,
            parentURL?: string | URL,
            options?: RegisterOptions<Data>,
        ): void;
        function register<Data ***REMOVED*** any>(specifier: string | URL, options?: RegisterOptions<Data>): void;
         ...
         * const code ***REMOVED*** 'const a: number ***REMOVED*** 1;';
         * const strippedCode ***REMOVED*** stripTypeScriptTypes(code);
         * console.log(strippedCode);
         * // Prints: const a         ***REMOVED*** 1;
         * ```
         *
         ...
         * import { stripTypeScriptTypes } from 'node:module';
         * const code ***REMOVED*** 'const a: number ***REMOVED*** 1;';
         * const strippedCode ***REMOVED*** stripTypeScriptTypes(code, { mode: 'strip', sourceUrl: 'source.ts' });
         * console.log(strippedCode);
         * // Prints: const a         ***REMOVED*** 1\n\n//# sourceURL***REMOVED***source.ts;
         * ```
         *
         ...
         * const code ***REMOVED*** `
         *   namespace MathUtil {
         *     export const add ***REMOVED*** (a: number, b: number) ***REMOVED***> a + b;
         *   }`;
         * const strippedCode ***REMOVED*** stripTypeScriptTypes(code, { mode: 'transform', sourceMap: true });
         * console.log(strippedCode);
         * // Prints:
         * // var MathUtil;
         * // (function(MathUtil) {
         * //     MathUtil.add ***REMOVED*** (a, b)***REMOVED***>a + b;
         * // })(MathUtil || (MathUtil ***REMOVED*** {}));
         * // # sourceMappingURL***REMOVED***data:application/json;base64, ...
         * ```
         * @since v22.13.0
         ...
         * }
         *
         * fs.newAPI ***REMOVED*** newAPI;
         *
         * syncBuiltinESMExports();
         *
         * import('node:fs').then((esmFS) ***REMOVED***> {
        ...
        type ModuleFormat ***REMOVED***
            ...
            | "module-typescript"
            | "wasm";
        type ModuleSource ***REMOVED*** string | ArrayBuffer | NodeJS.TypedArray;
        /**
         ...
         * execution resumes.
         */
        type InitializeHook<Data ***REMOVED*** any> ***REMOVED*** (data: Data) ***REMOVED***> void | Promise<void>;
         ...
         */
        type ResolveHook ***REMOVED*** (
            specifier: string,
            context: ResolveHookContext,
            nextResolve: (
                specifier: string,
                context?: Partial<ResolveHookContext>,
            ) ***REMOVED***> ResolveFnOutput | Promise<ResolveFnOutput>,
        ) ***REMOVED***> ResolveFnOutput | Promise<ResolveFnOutput>;
        type ResolveHookSync ***REMOVED*** (
            specifier: string,
            context: ResolveHookContext,
            nextResolve: (
                specifier: string,
                context?: Partial<ResolveHookContext>,
            ) ***REMOVED***> ResolveFnOutput,
        ) ***REMOVED***> ResolveFnOutput;
         ...
         */
        type LoadHook ***REMOVED*** (
            url: string,
            context: LoadHookContext,
            nextLoad: (
                url: string,
                context?: Partial<LoadHookContext>,
            ) ***REMOVED***> LoadFnOutput | Promise<LoadFnOutput>,
        ) ***REMOVED***> LoadFnOutput | Promise<LoadFnOutput>;
        type LoadHookSync ***REMOVED*** (
            url: string,
            context: LoadHookContext,
            nextLoad: (
                url: string,
                context?: Partial<LoadHookContext>,
            ) ***REMOVED***> LoadFnOutput,
        ) ***REMOVED***> LoadFnOutput;
    ...
    global {
        interface ImportMeta {
             ...
             * const buffer ***REMOVED*** readFileSync(new URL('./data.proto', import.meta.url));
             * ```
             */
            url: string;
            /**
             ...
             *
             * ```js
             * const dependencyAsset ***REMOVED*** import.meta.resolve('component-lib/asset.css');
             ...
             *
             * Equivalent to `require.main ***REMOVED******REMOVED******REMOVED*** module` in CommonJS.
             *
             * Analogous to Python's `__name__ ***REMOVED******REMOVED*** "__main__"`.
             *
             * ```js
             * export function foo() {
             *   return 'Hello, world';
        ...
        namespace NodeJS {
            ...
            /** @deprecated */
            interface RequireExtensions extends Dict<(module: Module, filename: string) ***REMOVED***> any> {
                ".js": (module: Module, filename: string) ***REMOVED***> any;
                ".json": (module: Module, filename: string) ***REMOVED***> any;
                ".node": (module: Module, filename: string) ***REMOVED***> any;
            }
    ...
    export ***REMOVED*** Module;
}
declare module "node:module" {
    import module ***REMOVED*** require("module");
    export ***REMOVED*** module;
}
