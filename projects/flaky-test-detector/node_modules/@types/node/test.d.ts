 ...
 *
 * ```js
 * test('synchronous passing test', (t) ***REMOVED***> {
 *   // This test passes because it does not throw an exception.
 *   assert.strictEqual(1, 1);
 * });
 *
 * test('synchronous failing test', (t) ***REMOVED***> {
 *   // This test fails because it throws an exception.
 *   assert.strictEqual(1, 2);
 * });
 *
 * test('asynchronous passing test', async (t) ***REMOVED***> {
 *   // This test passes because the Promise returned by the async
 *   // function is settled and not rejected.
 *   assert.strictEqual(1, 1);
 * });
 *
 * test('asynchronous failing test', async (t) ***REMOVED***> {
 *   // This test fails because the Promise returned by the async
 *   // function is rejected.
 *   assert.strictEqual(1, 2);
 * });
 *
 * test('failing test using Promises', (t) ***REMOVED***> {
 ...
 * });
 *
 * test('callback passing test', (t, done) ***REMOVED***> {
 *   // done() is the callback function. When the setImmediate() runs, it invokes
 *   // done() with no arguments.
 *   setImmediate(done);
 * });
 *
 * test('callback failing test', (t, done) ***REMOVED***> {
...
declare module "node:test" {
    ...
    import TestFn ***REMOVED*** test.TestFn;
    import TestOptions ***REMOVED*** test.TestOptions;
    /**
    ...
    namespace test {
         ...
         * If the test uses callbacks, the callback function is passed as the second argument.
         */
        type TestFn ***REMOVED*** (t: TestContext, done: (result?: any) ***REMOVED***> void) ***REMOVED***> void | Promise<void>;
        /**
         * The type of a suite test function. The argument to this function is a {@link SuiteContext} object.
         */
        type SuiteFn ***REMOVED*** (s: SuiteContext) ***REMOVED***> void | Promise<void>;
        interface TestShard {
            /**
        ...
        interface RunOptions {
             ...
             * @default undefined
             */
            inspectPort?: number | (() ***REMOVED***> number) | undefined;
            /**
             ...
             * @default undefined
             */
            setup?: ((reporter: TestsStream) ***REMOVED***> void | Promise<void>) | undefined;
            /**
        ...
        interface TestsStream extends Readable {
            addListener(event: "test:coverage", listener: (data: EventData.TestCoverage) ***REMOVED***> void): this;
            addListener(event: "test:complete", listener: (data: EventData.TestComplete) ***REMOVED***> void): this;
            addListener(event: "test:dequeue", listener: (data: EventData.TestDequeue) ***REMOVED***> void): this;
            addListener(event: "test:diagnostic", listener: (data: EventData.TestDiagnostic) ***REMOVED***> void): this;
            addListener(event: "test:enqueue", listener: (data: EventData.TestEnqueue) ***REMOVED***> void): this;
            addListener(event: "test:fail", listener: (data: EventData.TestFail) ***REMOVED***> void): this;
            addListener(event: "test:pass", listener: (data: EventData.TestPass) ***REMOVED***> void): this;
            addListener(event: "test:plan", listener: (data: EventData.TestPlan) ***REMOVED***> void): this;
            addListener(event: "test:start", listener: (data: EventData.TestStart) ***REMOVED***> void): this;
            addListener(event: "test:stderr", listener: (data: EventData.TestStderr) ***REMOVED***> void): this;
            addListener(event: "test:stdout", listener: (data: EventData.TestStdout) ***REMOVED***> void): this;
            addListener(event: "test:summary", listener: (data: EventData.TestSummary) ***REMOVED***> void): this;
            addListener(event: "test:watch:drained", listener: () ***REMOVED***> void): this;
            ...
            on(event: "test:coverage", listener: (data: EventData.TestCoverage) ***REMOVED***> void): this;
            on(event: "test:complete", listener: (data: EventData.TestComplete) ***REMOVED***> void): this;
            on(event: "test:dequeue", listener: (data: EventData.TestDequeue) ***REMOVED***> void): this;
            on(event: "test:diagnostic", listener: (data: EventData.TestDiagnostic) ***REMOVED***> void): this;
            on(event: "test:enqueue", listener: (data: EventData.TestEnqueue) ***REMOVED***> void): this;
            on(event: "test:fail", listener: (data: EventData.TestFail) ***REMOVED***> void): this;
            on(event: "test:pass", listener: (data: EventData.TestPass) ***REMOVED***> void): this;
            on(event: "test:plan", listener: (data: EventData.TestPlan) ***REMOVED***> void): this;
            on(event: "test:start", listener: (data: EventData.TestStart) ***REMOVED***> void): this;
            on(event: "test:stderr", listener: (data: EventData.TestStderr) ***REMOVED***> void): this;
            on(event: "test:stdout", listener: (data: EventData.TestStdout) ***REMOVED***> void): this;
            on(event: "test:summary", listener: (data: EventData.TestSummary) ***REMOVED***> void): this;
            on(event: "test:watch:drained", listener: () ***REMOVED***> void): this;
            on(event: string, listener: (...args: any[]) ***REMOVED***> void): this;
            once(event: "test:coverage", listener: (data: EventData.TestCoverage) ***REMOVED***> void): this;
            once(event: "test:complete", listener: (data: EventData.TestComplete) ***REMOVED***> void): this;
            once(event: "test:dequeue", listener: (data: EventData.TestDequeue) ***REMOVED***> void): this;
            once(event: "test:diagnostic", listener: (data: EventData.TestDiagnostic) ***REMOVED***> void): this;
            once(event: "test:enqueue", listener: (data: EventData.TestEnqueue) ***REMOVED***> void): this;
            once(event: "test:fail", listener: (data: EventData.TestFail) ***REMOVED***> void): this;
            once(event: "test:pass", listener: (data: EventData.TestPass) ***REMOVED***> void): this;
            once(event: "test:plan", listener: (data: EventData.TestPlan) ***REMOVED***> void): this;
            once(event: "test:start", listener: (data: EventData.TestStart) ***REMOVED***> void): this;
            once(event: "test:stderr", listener: (data: EventData.TestStderr) ***REMOVED***> void): this;
            once(event: "test:stdout", listener: (data: EventData.TestStdout) ***REMOVED***> void): this;
            once(event: "test:summary", listener: (data: EventData.TestSummary) ***REMOVED***> void): this;
            once(event: "test:watch:drained", listener: () ***REMOVED***> void): this;
            once(event: string, listener: (...args: any[]) ***REMOVED***> void): this;
            prependListener(event: "test:coverage", listener: (data: EventData.TestCoverage) ***REMOVED***> void): this;
            prependListener(event: "test:complete", listener: (data: EventData.TestComplete) ***REMOVED***> void): this;
            prependListener(event: "test:dequeue", listener: (data: EventData.TestDequeue) ***REMOVED***> void): this;
            prependListener(event: "test:diagnostic", listener: (data: EventData.TestDiagnostic) ***REMOVED***> void): this;
            prependListener(event: "test:enqueue", listener: (data: EventData.TestEnqueue) ***REMOVED***> void): this;
            prependListener(event: "test:fail", listener: (data: EventData.TestFail) ***REMOVED***> void): this;
            prependListener(event: "test:pass", listener: (data: EventData.TestPass) ***REMOVED***> void): this;
            prependListener(event: "test:plan", listener: (data: EventData.TestPlan) ***REMOVED***> void): this;
            prependListener(event: "test:start", listener: (data: EventData.TestStart) ***REMOVED***> void): this;
            prependListener(event: "test:stderr", listener: (data: EventData.TestStderr) ***REMOVED***> void): this;
            prependListener(event: "test:stdout", listener: (data: EventData.TestStdout) ***REMOVED***> void): this;
            prependListener(event: "test:summary", listener: (data: EventData.TestSummary) ***REMOVED***> void): this;
            prependListener(event: "test:watch:drained", listener: () ***REMOVED***> void): this;
            prependListener(event: string, listener: (...args: any[]) ***REMOVED***> void): this;
            prependOnceListener(event: "test:coverage", listener: (data: EventData.TestCoverage) ***REMOVED***> void): this;
            prependOnceListener(event: "test:complete", listener: (data: EventData.TestComplete) ***REMOVED***> void): this;
            prependOnceListener(event: "test:dequeue", listener: (data: EventData.TestDequeue) ***REMOVED***> void): this;
            prependOnceListener(event: "test:diagnostic", listener: (data: EventData.TestDiagnostic) ***REMOVED***> void): this;
            prependOnceListener(event: "test:enqueue", listener: (data: EventData.TestEnqueue) ***REMOVED***> void): this;
            prependOnceListener(event: "test:fail", listener: (data: EventData.TestFail) ***REMOVED***> void): this;
            prependOnceListener(event: "test:pass", listener: (data: EventData.TestPass) ***REMOVED***> void): this;
            prependOnceListener(event: "test:plan", listener: (data: EventData.TestPlan) ***REMOVED***> void): this;
            prependOnceListener(event: "test:start", listener: (data: EventData.TestStart) ***REMOVED***> void): this;
            prependOnceListener(event: "test:stderr", listener: (data: EventData.TestStderr) ***REMOVED***> void): this;
            prependOnceListener(event: "test:stdout", listener: (data: EventData.TestStdout) ***REMOVED***> void): this;
            prependOnceListener(event: "test:summary", listener: (data: EventData.TestSummary) ***REMOVED***> void): this;
            prependOnceListener(event: "test:watch:drained", listener: () ***REMOVED***> void): this;
        ...
        interface TestContext {
             ...
             * test('example', (t: TestContext) ***REMOVED***> {
             *   t.assert.deepStrictEqual(actual, expected);
             * });
             *
             * // Omitting the type annotation will result in a compilation error.
             * test('example', t ***REMOVED***> {
             ...
             *
             * ```js
             * test('planning with streams', (t, done) ***REMOVED***> {
             *   function* generate() {
             *     yield 'a';
             *     yield 'b';
             *     yield 'c';
             *   }
             *   const expected ***REMOVED*** ['a', 'b', 'c'];
             *   t.plan(expected.length);
             *   const stream ***REMOVED*** Readable.from(generate());
             ...
             *
             * ```js
             * test('plan with wait: 2000 waits for async assertions', (t) ***REMOVED***> {
             *   t.plan(1, { wait: 2000 }); // Waits for up to 2 seconds for the assertion to complete.
             *
             *   const asyncActivity ***REMOVED*** () ***REMOVED***> {
             *     setTimeout(() ***REMOVED***> {
             ...
             */
            waitFor<T>(condition: () ***REMOVED***> T, options?: TestContextWaitForOptions): Promise<Awaited<T>>;
            /**
        ...
        interface TestContextAssert extends Pick<typeof import("assert"), AssertMethodNames> {
             ...
             *
             * ```js
             * test('snapshot test with default serialization', (t) ***REMOVED***> {
             ...
             * });
             *
             * test('snapshot test with custom serialization', (t) ***REMOVED***> {
             *   t.assert.snapshot({ value3: 3, value4: 4 }, {
             *     serializers: [(value) ***REMOVED***> JSON.stringify(value)]
             *   });
             * });
             * ```
             * @since v22.3.0
             ...
             */
            [name: string]: (...args: any[]) ***REMOVED***> void;
        }
        interface AssertSnapshotOptions {
             ...
             */
            serializers?: ReadonlyArray<(value: any) ***REMOVED***> any> | undefined;
        }
         ...
         *
         * ```js
         * describe('tests', async () ***REMOVED***> {
         *   before(() ***REMOVED***> console.log('about to run some test'));
         *   it('is a subtest', () ***REMOVED***> {
         ...
         * ```js
         * describe('tests', async () ***REMOVED***> {
         *   after(() ***REMOVED***> console.log('finished running tests'));
         *   it('is a subtest', () ***REMOVED***> {
         *     assert.ok('some relevant assertion here');
         *   });
         * });
         ...
         * ```js
         * describe('tests', async () ***REMOVED***> {
         *   beforeEach(() ***REMOVED***> console.log('about to run a test'));
         *   it('is a subtest', () ***REMOVED***> {
         *     assert.ok('some relevant assertion here');
         *   });
         * });
         ...
         * ```js
         * describe('tests', async () ***REMOVED***> {
         *   afterEach(() ***REMOVED***> console.log('finished running a test'));
         *   it('is a subtest', () ***REMOVED***> {
         *     assert.ok('some relevant assertion here');
         *   });
         * });
         ...
         * If the hook uses callbacks, the callback function is passed as the second argument.
         */
        type HookFn ***REMOVED*** (c: TestContext | SuiteContext, done: (result?: any) ***REMOVED***> void) ***REMOVED***> any;
        /**
         * The hook function. The first argument is a `TestContext` object.
         * If the hook uses callbacks, the callback function is passed as the second argument.
         */
        type TestContextHookFn ***REMOVED*** (t: TestContext, done: (result?: any) ***REMOVED***> void) ***REMOVED***> any;
        /**
        ...
        type Mock<F extends Function> ***REMOVED*** F & {
        ...
        interface MockTracker {
             ...
             *
             * ```js
             * test('mocks a counting function', (t) ***REMOVED***> {
             *   let cnt ***REMOVED*** 0;
             *
             *   function addOne() {
             *     cnt++;
             ...
             *   }
             *
             *   const fn ***REMOVED*** t.mock.fn(addOne, addTwo, { times: 2 });
             *
             ...
             */
            fn<F extends Function ***REMOVED*** (...args: any[]) ***REMOVED***> undefined>(
                original?: F,
                options?: MockFunctionOptions,
            ): Mock<F>;
            fn<F extends Function ***REMOVED*** (...args: any[]) ***REMOVED***> undefined, Implementation extends Function ***REMOVED*** F>(
                original?: F,
             ...
             *
             * ```js
             * test('spies on an object method', (t) ***REMOVED***> {
             ...
             *
             *   const call ***REMOVED*** number.subtract.mock.calls[0];
             *
            ...
            >(
                ...
                methodName: MethodName,
                options?: MockFunctionOptions,
            ): Mock<() ***REMOVED***> MockedObject[MethodName]>;
            getter<
                MockedObject extends object,
                MethodName extends keyof MockedObject,
                Implementation extends Function,
            >(
                ...
                implementation?: Implementation,
                options?: MockFunctionOptions,
            ): Mock<(() ***REMOVED***> MockedObject[MethodName]) | Implementation>;
            /**
            ...
            >(
                ...
                methodName: MethodName,
                options?: MockFunctionOptions,
            ): Mock<(value: MockedObject[MethodName]) ***REMOVED***> void>;
            setter<
                MockedObject extends object,
                MethodName extends keyof MockedObject,
                Implementation extends Function,
            >(
                ...
                implementation?: Implementation,
                options?: MockFunctionOptions,
            ): Mock<((value: MockedObject[MethodName]) ***REMOVED***> void) | Implementation>;
            /**
        ...
        interface MockFunctionCall<
            F extends Function,
            ReturnType ***REMOVED*** F extends (...args: any) ***REMOVED***> infer T ? T
                : F extends abstract new(...args: any) ***REMOVED***> infer T ? T
                : unknown,
            Args ***REMOVED*** F extends (...args: infer Y) ***REMOVED***> any ? Y
                : F extends abstract new(...args: infer Y) ***REMOVED***> any ? Y
                : unknown[],
        > {
            /**
             ...
             */
            target: F extends abstract new(...args: any) ***REMOVED***> any ? F : undefined;
            /**
        ...
        interface MockFunctionContext<F extends Function> {
             ...
             *
             * ```js
             * test('changes a mock behavior', (t) ***REMOVED***> {
             *   let cnt ***REMOVED*** 0;
             *
             *   function addOne() {
             *     cnt++;
             ...
             *   }
             *
             *   const fn ***REMOVED*** t.mock.fn(addOne);
             *
             ...
             *
             * ```js
             * test('changes a mock behavior once', (t) ***REMOVED***> {
             *   let cnt ***REMOVED*** 0;
             *
             *   function addOne() {
             *     cnt++;
        ...
        interface MockTimers {
             ...
             * import { test } from 'node:test';
             * test('sets the time of a date object', (context) ***REMOVED***> {
             ...
             * import { test } from 'node:test';
             *
             * test('mocks setTimeout to be executed synchronously without having to actually wait for it', (context) ***REMOVED***> {
             *   const fn ***REMOVED*** context.mock.fn();
             *
             ...
             *   const fn ***REMOVED*** context.mock.fn();
             *   context.mock.timers.enable({ apis: ['setTimeout'] });
             *   const nineSecs ***REMOVED*** 9000;
             *   setTimeout(fn, nineSecs);
             *
             *   const twoSeconds ***REMOVED*** 3000;
             ...
             * import { test } from 'node:test';
             *
             * test('runAll functions following the given order', (context) ***REMOVED***> {
             *   context.mock.timers.enable({ apis: ['setTimeout', 'Date'] });
             *   const results ***REMOVED*** [];
             *   setTimeout(() ***REMOVED***> results.push(1), 9999);
             *
             *   // Notice that if both timers have the same timeout,
             *   // the order of execution is guaranteed
             *   setTimeout(() ***REMOVED***> results.push(3), 8888);
             *   setTimeout(() ***REMOVED***> results.push(2), 8888);
             *
        ...
        namespace assert {
             ...
             * @since v22.14.0
             */
            function register(name: string, fn: (this: TestContext, ...args: any[]) ***REMOVED***> void): void;
        }
        /**
         * @since v22.3.0
         */
        namespace snapshot {
             ...
             */
            function setDefaultSnapshotSerializers(serializers: ReadonlyArray<(value: any) ***REMOVED***> any>): void;
            /**
             ...
             */
            function setResolveSnapshotPath(fn: (path: string | undefined) ***REMOVED***> string): void;
        }
    }
    type FunctionPropertyNames<T> ***REMOVED*** {
...
declare module "node:test/reporters" {
    ...
    type TestEventGenerator ***REMOVED*** AsyncGenerator<TestEvent, void>;

    interface ReporterConstructorWrapper<T extends new(...args: any[]) ***REMOVED***> Transform> {
