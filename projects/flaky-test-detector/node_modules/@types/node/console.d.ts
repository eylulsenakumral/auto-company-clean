 ...
 *
 * const name ***REMOVED*** 'Will Robinson';
 ...
 *
 * ```js
 * const out ***REMOVED*** getStreamSomehow();
 * const err ***REMOVED*** getStreamSomehow();
 * const myConsole ***REMOVED*** new console.Console(out, err);
 *
...
declare module "console" {
    import console ***REMOVED*** require("node:console");
    export ***REMOVED*** console;
}
declare module "node:console" {
    ...
    global {
        ...
        interface Console {
             ...
             * ```
             * @since v8.3.0
             * @param [label***REMOVED***'default'] The display label for the counter.
             */
             ...
             * const value ***REMOVED*** expensiveProcess1(); // Returns 42
    ...
    export ***REMOVED*** globalThis.console;
}
