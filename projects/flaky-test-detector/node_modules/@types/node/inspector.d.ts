...
declare module "inspector" {
    ...
    namespace NetworkResources {
         ...
         *
         * ```js
         * const inspector ***REMOVED*** require('node:inspector');
         ...
         *   const mapUrl ***REMOVED*** 'http://localhost:3000/dist/app.js.map';
         *   const tsUrl ***REMOVED*** 'http://localhost:3000/src/app.ts';
         *   const distAppJsMap ***REMOVED*** await fetch(mapUrl).then((res) ***REMOVED***> res.text());
         *   const srcAppTs ***REMOVED*** await fetch(tsUrl).then((res) ***REMOVED***> res.text());
         *   inspector.NetworkResources.put(mapUrl, distAppJsMap);
         *   inspector.NetworkResources.put(tsUrl, srcAppTs);
         * };
         * setNetworkResources().then(() ***REMOVED***> {
         *   require('./dist/app');
         * });
         * ```
         *
