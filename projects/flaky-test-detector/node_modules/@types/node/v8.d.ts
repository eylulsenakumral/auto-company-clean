...
declare module "v8" {
    ...
    // ** Signifies if the --zap_code_space option is enabled or not.  1 ***REMOVED******REMOVED*** enabled, 0 ***REMOVED******REMOVED*** disabled. */
    type DoesZapCodeSpaceFlag ***REMOVED*** 0 | 1;
    interface HeapInfo {
     ...
     * class A { foo ***REMOVED*** 'bar'; }
     * console.log(queryObjects(A)); // 0
     * const a ***REMOVED*** new A();
     * console.log(queryObjects(A)); // 1
     * // [ "A { foo: 'bar' }" ]
     * console.log(queryObjects(A, { format: 'summary' }));
     *
     * class B extends A { bar ***REMOVED*** 'qux'; }
     * const b ***REMOVED*** new B();
     ...
     * import v8 from 'node:v8';
     * const stream ***REMOVED*** v8.getHeapSnapshot();
     ...
     *     if (message ***REMOVED******REMOVED******REMOVED*** 'heapdump') {
     ...
     *
     * ```js
     * const { isStringOneByteRepresentation } ***REMOVED*** require('node:v8');
     *
     * const Encoding ***REMOVED*** {
     *   latin1: 1,
     *   utf16le: 2,
     * };
     * const buffer ***REMOVED*** Buffer.alloc(100);
    ...
    class GCProfiler {
         ...
         * const profiler ***REMOVED*** new GCProfiler();
         * profiler.start();
         * setTimeout(() ***REMOVED***> {
    ...
    interface PromiseHooks {
         ...
         */
        onInit: (init: Init) ***REMOVED***> Function;
        /**
         ...
         * @return Call to stop the hook.
         */
        onSettled: (settled: Settled) ***REMOVED***> Function;
        /**
         ...
         * @return Call to stop the hook.
         */
        onBefore: (before: Before) ***REMOVED***> Function;
        /**
         ...
         * @return Call to stop the hook.
         */
        onAfter: (after: After) ***REMOVED***> Function;
        /**
         ...
         */
        createHook: (callbacks: HookCallbacks) ***REMOVED***> Function;
    }
    /**
    ...
    type StartupSnapshotCallbackFn ***REMOVED*** (args: any) ***REMOVED***> any;
    /**
     ...
     * const shelf ***REMOVED*** new BookShelf(__dirname, [
     *   'book1.en_US.txt',
     *   'book1.es_ES.txt',
     *   'book2.zh_CN.txt',
     * ]);
     ...
     * v8.startupSnapshot.setDeserializeMainFunction((shelf) ***REMOVED***> {
     *   // process.env and process.argv are refreshed during snapshot
     *   // deserialization.
     *   const lang ***REMOVED*** process.env.BOOK_LANG || 'en_US';
     *   const book ***REMOVED*** process.argv[1];
     *   const name ***REMOVED*** `${book}.${lang}.txt`;
     ...
     *
     * ```bash
     * $ BOOK_LANG***REMOVED***es_ES node --snapshot-blob snapshot.blob book1
