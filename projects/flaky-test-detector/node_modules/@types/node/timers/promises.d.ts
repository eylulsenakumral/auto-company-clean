...
declare module "timers/promises" {
     ...
     * } from 'node:timers/promises';
     *
     * const res ***REMOVED*** await setTimeout(100, 'result');
     *
     ...
     */
    function setTimeout<T ***REMOVED*** void>(delay?: number, value?: T, options?: TimerOptions): Promise<T>;
    /**
     * ```js
     * import {
     *   setImmediate,
     * } from 'node:timers/promises';
     *
     * const res ***REMOVED*** await setImmediate('result');
     *
     * console.log(res);  // Prints 'result'
     * ```
     * @since v15.0.0
     * @param value A value with which the promise is fulfilled.
     */
    function setImmediate<T ***REMOVED*** void>(value?: T, options?: TimerOptions): Promise<T>;
    /**
     ...
     */
    function setInterval<T ***REMOVED*** void>(delay?: number, value?: T, options?: TimerOptions): NodeJS.AsyncIterator<T>;
    interface Scheduler {
        /**
