declare module "process" {
    ...
    global {
        ...
        namespace NodeJS {
            ...
            type Signals ***REMOVED***
                ...
                | "SIGLOST"
                | "SIGINFO";
            type UncaughtExceptionOrigin ***REMOVED*** "uncaughtException" | "unhandledRejection";
            type MultipleResolveType ***REMOVED*** "resolve" | "reject";
            type BeforeExitListener ***REMOVED*** (code: number) ***REMOVED***> void;
            type DisconnectListener ***REMOVED*** () ***REMOVED***> void;
            type ExitListener ***REMOVED*** (code: number) ***REMOVED***> void;
            type RejectionHandledListener ***REMOVED*** (promise: Promise<unknown>) ***REMOVED***> void;
            type UncaughtExceptionListener ***REMOVED*** (error: Error, origin: UncaughtExceptionOrigin) ***REMOVED***> void;
            /**
             * Most of the time the unhandledRejection will be an Error, but this should not be relied upon
             * as *anything* can be thrown/rejected, it is therefore unsafe to assume that the value is an Error.
             */
            type UnhandledRejectionListener ***REMOVED*** (reason: unknown, promise: Promise<unknown>) ***REMOVED***> void;
            type WarningListener ***REMOVED*** (warning: Error) ***REMOVED***> void;
            type MessageListener ***REMOVED*** (message: unknown, sendHandle: SendHandle) ***REMOVED***> void;
            type SignalsListener ***REMOVED*** (signal: Signals) ***REMOVED***> void;
            type MultipleResolveListener ***REMOVED*** (
                type: MultipleResolveType,
                promise: Promise<unknown>,
                value: unknown,
            ) ***REMOVED***> void;
            type WorkerListener ***REMOVED*** (worker: Worker) ***REMOVED***> void;
            ...
            interface HRTime {
                 ...
                 * const NS_PER_SEC ***REMOVED*** 1e9;
                 * const time ***REMOVED*** hrtime();
                 * // [ 1800216, 25 ]
                 *
                 * setTimeout(() ***REMOVED***> {
                 *   const diff ***REMOVED*** hrtime(time);
                 *   // [ 1, 552 ]
                 *
                 ...
                 *
                 * const start ***REMOVED*** hrtime.bigint();
                 * // 191051479007711n
                 *
                 * setTimeout(() ***REMOVED***> {
                 *   const end ***REMOVED*** hrtime.bigint();
                 *   // 191052633396993n
                 *
            ...
            interface Process extends EventEmitter {
                 ...
                 *
                 * ```bash
                 * node process-args.js one two***REMOVED***three four
                 * ```
                 *
                 ...
                 *
                 * ```bash
                 * node --icu-data-dir***REMOVED***./foo --require ./bar.js script.js --version
                 * ```
                 *
                 * Results in `process.execArgv`:
                 *
                 * ```js
                 * ["--icu-data-dir***REMOVED***./foo", "--require", "./bar.js"]
                 * ```
                 *
                 * And `process.argv`:
                 *
                 ...
                 *
                 * process.debugPort ***REMOVED*** 5858;
                 * ```
                 * @since v0.7.2
                 */
                debugPort: number;
                 ...
                 * const myWarning ***REMOVED*** new Error('Something happened!');
                 * // Use the Error name property to specify the type name
                 * myWarning.name ***REMOVED*** 'CustomWarning';
                 * myWarning.code ***REMOVED*** 'WARN001';
                 *
                 ...
                 *
                 * ```bash
                 * node -e 'process.env.foo ***REMOVED*** "bar"' &#x26;&#x26; echo $foo
                 * ```
                 *
                 ...
                 * import { env } from 'node:process';
                 *
                 * env.test ***REMOVED*** null;
                 * console.log(env.test);
                 * // ***REMOVED***> 'null'
                 * env.test ***REMOVED*** undefined;
                 * console.log(env.test);
                 * // ***REMOVED***> 'undefined'
                 * ```
                 *
                 ...
                 * @since v0.1.13
                 * @param [code***REMOVED***0] The exit code. For string type, only integer strings (e.g.,'1') are allowed.
                 */
                ...
                finalization: {
                     ...
                     * @experimental
                     */
                    register<T extends object>(ref: T, callback: (ref: T, event: "exit") ***REMOVED***> void): void;
                    /**
                     ...
                     * @experimental
                     */
                    registerBeforeExit<T extends object>(ref: T, callback: (ref: T, event: "beforeExit") ***REMOVED***> void): void;
                    /**
                 ...
                 */
                setgid?: (id: number | string) ***REMOVED***> void;
                /**
                 ...
                 * @since v0.1.28
                 */
                setuid?: (id: number | string) ***REMOVED***> void;
                /**
                 ...
                 */
                seteuid?: (id: number | string) ***REMOVED***> void;
                /**
                 ...
                 */
                setegid?: (id: number | string) ***REMOVED***> void;
                /**
                 ...
                 * @since v0.9.4
                 */
                setgroups?: (groups: ReadonlyArray<string | number>) ***REMOVED***> void;
                /**
                 ...
                 * @since v9.3.0
                 */
                setUncaughtExceptionCaptureCallback(cb: ((err: Error) ***REMOVED***> void) | null): void;
                /**
                 ...
                 * @param [signal***REMOVED***'SIGTERM'] The signal to send, either as a string or number.
                 */
                 ...
                 *
                 * const startUsage ***REMOVED*** cpuUsage();
                 ...
                 * }
                 *
                 * const thing ***REMOVED*** new MyThing();
                 ...
                 *
                 * ```js
                 * const maybeTrue ***REMOVED*** Math.random() > 0.5;
                 *
                 ...
                 * etc.
                 * * Flags may contain one or more equals (`***REMOVED***`) characters; all
                 * characters after and including the first equals will be ignored;
                 * e.g., `--stack-trace-limit***REMOVED***100`.
                 ...
                 * > process.throwDeprecation ***REMOVED*** true;
                 * true
                 * > process.emitWarning('test', 'DeprecationWarning');
                 * Thrown:
                ...
                addListener(event: "workerMessage", listener: (value: any, source: number) ***REMOVED***> void): this;
                ...
                on(event: "workerMessage", listener: (value: any, source: number) ***REMOVED***> void): this;
                ...
                once(event: "workerMessage", listener: (value: any, source: number) ***REMOVED***> void): this;
                ...
                prependListener(event: "workerMessage", listener: (value: any, source: number) ***REMOVED***> void): this;
                ...
                prependOnceListener(event: "workerMessage", listener: (value: any, source: number) ***REMOVED***> void): this;
                ...
                listeners(event: "workerMessage"): ((value: any, source: number) ***REMOVED***> void)[];
    ...
    export ***REMOVED*** process;
}
declare module "node:process" {
    import process ***REMOVED*** require("process");
    export ***REMOVED*** process;
}
