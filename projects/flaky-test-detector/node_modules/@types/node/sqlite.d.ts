 ...
 * const database ***REMOVED*** new DatabaseSync(':memory:');
 *
 ...
 * const insert ***REMOVED*** database.prepare('INSERT INTO data (key, value) VALUES (?, ?)');
 * // Execute the prepared statement with bound values.
 * insert.run(1, 'hello');
 * insert.run(2, 'world');
 * // Create a prepared statement to read data from the database.
 * const query ***REMOVED*** database.prepare('SELECT * FROM data ORDER BY key');
...
declare module "node:sqlite" {
    ...
    type SQLInputValue ***REMOVED*** null | number | bigint | string | NodeJS.ArrayBufferView;
    type SQLOutputValue ***REMOVED*** null | number | bigint | string | NodeJS.NonSharedUint8Array;
    ...
    interface ApplyChangesetOptions {
         ...
         * @since v22.12.0
         */
        filter?: ((tableName: string) ***REMOVED***> boolean) | undefined;
        /**
         ...
         * @since v22.12.0
         */
        onConflict?: ((conflictType: number) ***REMOVED***> number) | undefined;
    }
    ...
    interface AggregateOptions<T extends SQLInputValue ***REMOVED*** SQLInputValue> extends FunctionOptions {
        /**
         ...
         */
        step: (accumulator: T, ...args: SQLOutputValue[]) ***REMOVED***> T;
        /**
         ...
         */
        result?: ((accumulator: T) ***REMOVED***> SQLInputValue) | undefined;
        /**
         ...
         * new state.
         */
        inverse?: ((accumulator: T, ...args: SQLOutputValue[]) ***REMOVED***> T) | undefined;
    }
    /**
    ...
    class DatabaseSync implements Disposable {
         ...
         * import { DatabaseSync } from 'node:sqlite';
         *
         * const db ***REMOVED*** new DatabaseSync(':memory:');
         * db.exec(`
         *   CREATE TABLE t3(x, y);
         ...
         * db.aggregate('sumint', {
         *   start: 0,
         *   step: (acc, value) ***REMOVED***> acc + value,
         * });
         *
        ...
        function(
            ...
            func: (...args: SQLOutputValue[]) ***REMOVED***> SQLInputValue,
        ): void;
        function(name: string, func: (...args: SQLOutputValue[]) ***REMOVED***> SQLInputValue): void;
        /**
         ...
         *
         * ```js
         * const sourceDb ***REMOVED*** new DatabaseSync(':memory:');
         * const targetDb ***REMOVED*** new DatabaseSync(':memory:');
         *
         * sourceDb.exec('CREATE TABLE data(key INTEGER PRIMARY KEY, value TEXT)');
         * targetDb.exec('CREATE TABLE data(key INTEGER PRIMARY KEY, value TEXT)');
         *
         * const session ***REMOVED*** sourceDb.createSession();
         *
         * const insert ***REMOVED*** sourceDb.prepare('INSERT INTO data (key, value) VALUES (?, ?)');
         * insert.run(1, 'hello');
         * insert.run(2, 'world');
         *
         * const changeset ***REMOVED*** session.changeset();
    ...
    interface BackupOptions {
         ...
         * pages.
         */
        progress?: ((progressInfo: BackupProgressInfo) ***REMOVED***> void) | undefined;
    }
     ...
     *
     * const sourceDb ***REMOVED*** new DatabaseSync('source.db');
     * const totalPagesTransferred ***REMOVED*** await backup(sourceDb, 'backup.db', {
     *   rate: 1, // Copy one page at a time.
     *   progress: ({ totalPages, remainingPages }) ***REMOVED***> {
