...
declare module "timers" {
    ...
    global {
        ...
        function setImmediate<TArgs extends any[]>(
            callback: (...args: TArgs) ***REMOVED***> void,
            ...args: TArgs
        ): NodeJS.Immediate;
        // Allow a single void-accepting argument to be optional in arguments lists.
        // Allows usage such as `new Promise(resolve ***REMOVED***> setTimeout(resolve, ms))` (#54258)
        // eslint-disable-next-line @typescript-eslint/no-invalid-void-type
        function setImmediate(callback: (_: void) ***REMOVED***> void): NodeJS.Immediate;
        namespace setImmediate {
            import __promisify__ ***REMOVED*** promises.setImmediate;
        ...
        // Allows usage such as `new Promise(resolve ***REMOVED***> setTimeout(resolve, ms))` (#54258)
        // eslint-disable-next-line @typescript-eslint/no-invalid-void-type
        function setInterval(callback: (_: void) ***REMOVED***> void, delay?: number): NodeJS.Timeout;
        /**
        ...
        // Allows usage such as `new Promise(resolve ***REMOVED***> setTimeout(resolve, ms))` (#54258)
        // eslint-disable-next-line @typescript-eslint/no-invalid-void-type
        function setTimeout(callback: (_: void) ***REMOVED***> void, delay?: number): NodeJS.Timeout;
        namespace setTimeout {
            import __promisify__ ***REMOVED*** promises.setTimeout;
            export { __promisify__ };
        }
        /**
         ...
         */
        function queueMicrotask(callback: () ***REMOVED***> void): void;
    }
    import clearImmediate ***REMOVED*** globalThis.clearImmediate;
    import clearInterval ***REMOVED*** globalThis.clearInterval;
    import clearTimeout ***REMOVED*** globalThis.clearTimeout;
    import setImmediate ***REMOVED*** globalThis.setImmediate;
    import setInterval ***REMOVED*** globalThis.setInterval;
    import setTimeout ***REMOVED*** globalThis.setTimeout;
