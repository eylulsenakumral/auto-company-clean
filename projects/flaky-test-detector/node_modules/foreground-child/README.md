...
// cats out this file
const child ***REMOVED*** foregroundChild('cat', [__filename])
...
```js
const child ***REMOVED*** foregroundChild(`cat ${__filename}`, { shell: true })
```
...
```js
const child ***REMOVED*** foregroundChild('cat', [__filename], spawnOptions, () ***REMOVED***> {
  doSomeActions()
})
```
...
```js
const child ***REMOVED*** foregroundChild('cat', [__filename], async () ***REMOVED***> {
...
const childProcess ***REMOVED*** spawn('command', ['some', 'args'])
...
const childProcess ***REMOVED*** spawn('command', ['some', 'args'])
const watchdogProcess ***REMOVED*** watchdog(childProcess)
