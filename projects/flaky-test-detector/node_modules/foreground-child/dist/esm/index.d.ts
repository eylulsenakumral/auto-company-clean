 ...
 */
export type Cleanup ***REMOVED*** (code: number | null, signal: null | NodeJS.Signals, processInfo: {
...
export type FgArgs ***REMOVED*** [program: string | [cmd: string, ...args: string[]], cleanup?: Cleanup] | [
 ...
 * @internal
 */
export declare const normalizeFgArgs: (fgArgs: FgArgs) ***REMOVED***> [program: string, args: string[], spawnOpts: SpawnOptions, cleanup: Cleanup];
/**
