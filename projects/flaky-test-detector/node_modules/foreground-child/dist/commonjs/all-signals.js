...
exports.allSignals ***REMOVED*** void 0;
const node_constants_1 ***REMOVED*** __importDefault(require("node:constants"));
exports.allSignals ***REMOVED*** 
// this is the full list of signals that Node will let us do anything with
Object.keys(node_constants_1.default).filter(k ***REMOVED***> k.startsWith('SIG') &&
    // https://github.com/tapjs/signal-exit/issues/21
    k !***REMOVED******REMOVED*** 'SIGPROF' &&
    // no sense trying to listen for SIGKILL, it's impossible
    k !***REMOVED******REMOVED*** 'SIGKILL');
...
// 'SIGSTKFLT',
// 'SIGUNUSED',
//# sourceMappingURL***REMOVED***all-signals.js.map