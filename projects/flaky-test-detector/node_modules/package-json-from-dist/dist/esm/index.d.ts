 ...
 * ```
 */
export declare const findPackageJson: (from: string | URL, pathFromSrc?: string) ***REMOVED***> string;
/**
 ...
 *
 * const pj ***REMOVED*** loadPackageJson(import.meta.url)
 ...
 * import { loadPackageJson } from 'package-json-from-dist'
 *
 * const pj ***REMOVED*** loadPackageJson(import.meta.url, '../../package.json')
 * console.log(`Hello from ${pj.name}@${pj.version}`)
 * ```
 *
 * When running from CommmonJS, use `__filename` instead of `import.meta.url`
 ...
 * import { loadPackageJson } from 'package-json-from-dist'
 *
 * const pj ***REMOVED*** loadPackageJson(__filename)
 * console.log(`Hello from ${pj.name}@${pj.version}`)
 * ```
 */
export declare const loadPackageJson: (from: string | URL, pathFromSrc?: string) ***REMOVED***> any;
