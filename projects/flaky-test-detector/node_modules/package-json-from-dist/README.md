...
const pj ***REMOVED*** findPackageJson(import.meta.url)
console.log(`package.json found at ${pj}`)

const pkg ***REMOVED*** loadPackageJson(import.meta.url)
...
const pj ***REMOVED*** findPackageJson(import.meta.url, '../../package.json')
console.log(`package.json found at ${pj}`)

const pkg ***REMOVED*** loadPackageJson(import.meta.url, '../../package.json')
console.log(`Hello from ${pkg.name}@${pkg.version}`)
```
...
const pj ***REMOVED*** findPackageJson(__filename)
console.log(`package.json found at ${pj}`)

const pkg ***REMOVED*** loadPackageJson(__filename)
console.log(`Hello from ${pkg.name}@${pkg.version}`)
```
...
//@ts-ignore
export const pkg ***REMOVED*** loadPackageJson(import.meta.url)
//@ts-ignore
export const pj ***REMOVED*** findPackageJson(import.meta.url)
```
...
export const pkg ***REMOVED*** loadPackageJson(__filename)
export const pj ***REMOVED*** findPackageJson(__filename)
```
