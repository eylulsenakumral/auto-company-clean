...
```js
const spawn ***REMOVED*** require('cross-spawn');

// Spawn NPM asynchronously
const child ***REMOVED*** spawn('npm', ['list', '-g', '-depth', '0'], { stdio: 'inherit' });

// Spawn NPM synchronously
const result ***REMOVED*** spawn.sync('npm', ['list', '-g', '-depth', '0'], { stdio: 'inherit' });
```
