...
export type Platform ***REMOVED*** 'aix' | 'android' | 'darwin' | 'freebsd' | 'haiku' | 'linux' | 'openbsd' | 'sunos' | 'win32' | 'cygwin' | 'netbsd';
...
export declare const minimatch: {
    ...
    filter: (pattern: string, options?: MinimatchOptions) ***REMOVED***> (p: string) ***REMOVED***> boolean;
    defaults: (def: MinimatchOptions) ***REMOVED***> typeof minimatch;
    braceExpand: (pattern: string, options?: MinimatchOptions) ***REMOVED***> string[];
    makeRe: (pattern: string, options?: MinimatchOptions) ***REMOVED***> false | MMRegExp;
    match: (list: string[], pattern: string, options?: MinimatchOptions) ***REMOVED***> string[];
    AST: typeof AST;
    Minimatch: typeof Minimatch;
    escape: (s: string, { windowsPathsNoEscape, magicalBraces, }?: Pick<MinimatchOptions, "windowsPathsNoEscape" | "magicalBraces">) ***REMOVED***> string;
    unescape: (s: string, { windowsPathsNoEscape, magicalBraces, }?: Pick<MinimatchOptions, "windowsPathsNoEscape" | "magicalBraces">) ***REMOVED***> string;
};
export type Sep ***REMOVED*** '\\' | '/';
export declare const sep: Sep;
export declare const GLOBSTAR: unique symbol;
export declare const filter: (pattern: string, options?: MinimatchOptions) ***REMOVED***> (p: string) ***REMOVED***> boolean;
export declare const defaults: (def: MinimatchOptions) ***REMOVED***> typeof minimatch;
export declare const braceExpand: (pattern: string, options?: MinimatchOptions) ***REMOVED***> string[];
export declare const makeRe: (pattern: string, options?: MinimatchOptions) ***REMOVED***> false | MMRegExp;
export declare const match: (list: string[], pattern: string, options?: MinimatchOptions) ***REMOVED***> string[];
export type MMRegExp ***REMOVED*** RegExp & {
    _src?: string;
    _glob?: string;
};
export type ParseReturnFiltered ***REMOVED*** string | MMRegExp | typeof GLOBSTAR;
export type ParseReturn ***REMOVED*** ParseReturnFiltered | false;
