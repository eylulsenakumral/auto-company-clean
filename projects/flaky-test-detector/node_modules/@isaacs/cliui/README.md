...
// or: const { cliui } ***REMOVED*** require('cliui')
const ui ***REMOVED*** cliui()
...
<img width***REMOVED***"500" src***REMOVED***"screenshot.png">
...
```js
cliui ***REMOVED*** require('@isaacs/cliui')
```
