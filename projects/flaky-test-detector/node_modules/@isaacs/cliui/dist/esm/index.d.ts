export type UIOptions ***REMOVED*** {
    width: number;
    wrap?: boolean;
    rows?: string[];
};
export type Column ***REMOVED*** {
    text: string;
    width?: number;
...
export type ColumnArray ***REMOVED*** Column[] & {
    span?: boolean;
};
export type Line ***REMOVED*** {
    hidden?: boolean;
    text: string;
    span?: boolean;
};
...
export declare const cliui: (opts?: Partial<UIOptions>) ***REMOVED***> UI;
