...
// this works too:
// const { jack } ***REMOVED*** require('jackspeak/min')

const { positionals, values } ***REMOVED*** jack({ envPrefix: 'FOO' })
  .flag({
...
## `jack(options: JackOptions ***REMOVED*** {}) ***REMOVED***> Jack`
...
### `Jack.description(text: string, { pre?: boolean } ***REMOVED*** {})`
...
- `hint` (Only relevant for non-boolean types) The thing to show
  in the usage output, like `--option***REMOVED***<hint>`
...
### `Jack.parse(args: string[] ***REMOVED*** process.argv): { positionals: string[], values: OptionsResults }`
...
const j ***REMOVED*** jack({
  ...
  // -bofilename would be like --bail --output-file***REMOVED***filename
  .opt({
    'output-file': {
      short: 'o',
