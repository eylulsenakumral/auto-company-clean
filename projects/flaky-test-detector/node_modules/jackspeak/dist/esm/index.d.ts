...
export type ParseArgsOptions ***REMOVED*** Exclude<ParseArgsConfig['options'], undefined>;
export type ParseArgsOption ***REMOVED*** ParseArgsOptions[string];
export type ParseArgsDefault ***REMOVED*** Exclude<ConfigValue, number | number[]>;
export type ConfigType ***REMOVED*** 'number' | 'string' | 'boolean';
export declare const isConfigType: (t: unknown) ***REMOVED***> t is ConfigType;
export type ConfigValuePrimitive ***REMOVED*** string | boolean | number;
export type ConfigValueArray ***REMOVED*** string[] | boolean[] | number[];
export type ConfigValue ***REMOVED*** ConfigValuePrimitive | ConfigValueArray;
/**
 * Given a Jack object, get the typeof its ConfigSet
 */
export type Unwrap<J> ***REMOVED*** J extends Jack<infer C> ? C : never;
/**
 * Defines the type of value that is valid, given a config definition's
 * {@link ConfigType} and boolean multiple setting
 */
export type ValidValue<T extends ConfigType ***REMOVED*** ConfigType, M extends boolean ***REMOVED*** boolean> ***REMOVED*** [
    T,
    M
...
export type ReadonlyArrays ***REMOVED*** readonly number[] | readonly string[];
/**
 * Defines the type of validOptions that are valid, given a config definition's
 * {@link ConfigType}
 */
export type ValidOptions<T extends ConfigType> ***REMOVED*** T extends 'boolean' ? undefined : T extends 'string' ? readonly string[] : T extends 'number' ? readonly number[] : ReadonlyArrays;
/**
 * A config field definition, in its full representation.
 * This is what is passed in to addFields so `type` is required.
 */
export type ConfigOption<T extends ConfigType ***REMOVED*** ConfigType, M extends boolean ***REMOVED*** boolean, O extends undefined | ValidOptions<T> ***REMOVED*** undefined | ValidOptions<T>> ***REMOVED*** {
    type: T;
    short?: string;
    ...
    validate?: ((v: unknown) ***REMOVED***> v is ValidValue<T, M>) | ((v: unknown) ***REMOVED***> boolean);
    validOptions?: O;
 ...
 */
export declare const isConfigOptionOfType: <T extends ConfigType, M extends boolean>(o: unknown, type: T, multi: M) ***REMOVED***> o is ConfigOption<T, M>;
/**
 * Determine whether an unknown object is a {@link ConfigOption} based on
 * it having all valid properties
 */
export declare const isConfigOption: <T extends ConfigType, M extends boolean>(o: unknown, type: T, multi: M) ***REMOVED***> o is ConfigOption<T, M>;
/**
 ...
 */
export type ConfigOptionMeta<T extends ConfigType, M extends boolean, O extends ConfigOption<T, M> ***REMOVED*** ConfigOption<T, M>> ***REMOVED*** Pick<Partial<O>, 'type'> & Omit<O, 'type'>;
/**
 * A set of {@link ConfigOption} objects, referenced by their longOption
 * string values.
 */
export type ConfigSet ***REMOVED*** {
 ...
 * string values.
 */
export type ConfigMetaSet<T extends ConfigType, M extends boolean> ***REMOVED*** {
    [longOption: string]: ConfigOptionMeta<T, M>;
};
/**
 * Infer {@link ConfigSet} fields from a given {@link ConfigMetaSet}
 */
export type ConfigSetFromMetaSet<T extends ConfigType, M extends boolean, S extends ConfigMetaSet<T, M>> ***REMOVED*** S & {
 ...
 */
export type OptionsResults<T extends ConfigSet> ***REMOVED*** {
 ...
 */
export type Parsed<T extends ConfigSet> ***REMOVED*** {
 ...
 * string
 */
export type TextRow ***REMOVED*** Heading | Description;
/**
 * Either a {@link TextRow} or a reference to a {@link ConfigOption}
 */
export type UsageField ***REMOVED*** TextRow | {
    type: 'config';
    name: string;
    value: ConfigOption;
};
...
export interface JackOptions {
    ...
    /**
     * Conditional `stopAtPositional`. If set to a `(string)***REMOVED***>boolean` function,
     ...
     */
    stopAtPositionalTest?: (arg: string) ***REMOVED***> boolean;
}
/**
...
export declare class Jack<C extends ConfigSet ***REMOVED*** {}> {
    ...
    toJSON(): {
        [k: string]: {
            ...
            validate?: ((v: unknown) ***REMOVED***> boolean) | ((v: unknown) ***REMOVED***> v is ConfigValue) | undefined;
 ...
 */
export declare const jack: (options?: JackOptions) ***REMOVED***> Jack<{}>;
