...
export type PosInt ***REMOVED*** number & {
    [TYPE]: 'Positive Integer';
};
export type Index ***REMOVED*** number & {
    [TYPE]: 'LRUCache Index';
};
export type UintArray ***REMOVED*** Uint8Array | Uint16Array | Uint32Array;
export type NumberArray ***REMOVED*** UintArray | number[];
declare class ZeroArray extends Array<number> {
    constructor(size: number);
}
export type { ZeroArray };
export type { Stack };
export type StackLike ***REMOVED*** Stack | Index[];
declare class Stack {
    #private;
    heap: NumberArray;
    length: number;
 ...
 */
export type BackgroundFetch<V> ***REMOVED*** Promise<V | undefined> & {
    __returned: BackgroundFetch<V> | undefined;
    __abortController: AbortController;
    __staleWhileFetching: V | undefined;
};
export type DisposeTask<K, V> ***REMOVED*** [
    value: V,
    key: K,
...
export declare namespace LRUCache {
     ...
     */
    type Size ***REMOVED*** number;
    /**
     * Integer greater than 0, representing some number of milliseconds, or the
     * time at which a TTL started counting from.
     */
    type Milliseconds ***REMOVED*** number;
    /**
     * An integer greater than 0, reflecting a number of items
     */
    type Count ***REMOVED*** number;
    /**
     ...
     */
    type DisposeReason ***REMOVED*** 'evict' | 'set' | 'delete' | 'expire' | 'fetch';
    /**
     * A method called upon item removal, passed as the
     * {@link OptionsBase.dispose} and/or
     * {@link OptionsBase.disposeAfter} options.
     */
    type Disposer<K, V> ***REMOVED*** (value: V, key: K, reason: DisposeReason) ***REMOVED***> void;
    /**
     ...
     */
    type InsertReason ***REMOVED*** 'add' | 'update' | 'replace';
    /**
     * A method called upon item insertion, passed as the
     * {@link OptionsBase.insert}
     */
    type Inserter<K, V> ***REMOVED*** (value: V, key: K, reason: InsertReason) ***REMOVED***> void;
    /**
     * A function that returns the effective calculated size
     * of an entry in the cache.
     */
    type SizeCalculator<K, V> ***REMOVED*** (value: V, key: K) ***REMOVED***> Size;
    /**
     * Options provided to the
     * {@link OptionsBase.fetchMethod} function.
     */
    interface FetcherOptions<K, V, FC ***REMOVED*** unknown> {
        signal: AbortSignal;
     ...
     */
    interface Status<K, V, FC ***REMOVED*** unknown> {
        /**
     ...
     */
    interface FetcherFetchOptions<K, V, FC ***REMOVED*** unknown> extends Pick<OptionsBase<K, V, FC>, 'allowStale' | 'updateAgeOnGet' | 'noDeleteOnStaleGet' | 'sizeCalculation' | 'ttl' | 'noDisposeOnSet' | 'noUpdateTTL' | 'noDeleteOnFetchRejection' | 'allowStaleOnFetchRejection' | 'ignoreFetchAbort' | 'allowStaleOnFetchAbort'> {
     ...
     * `undefined` or `void`
     */
    interface FetchOptionsNoContext<K, V, FC extends undefined | void ***REMOVED*** undefined> extends FetchOptions<K, V, FC> {
        context?: FC;
    }
    interface MemoOptions<K, V, FC ***REMOVED*** unknown> extends Pick<OptionsBase<K, V, FC>, 'allowStale' | 'updateAgeOnGet' | 'noDeleteOnStaleGet' | 'sizeCalculation' | 'ttl' | 'noDisposeOnSet' | 'noUpdateTTL' | 'noDeleteOnFetchRejection' | 'allowStaleOnFetchRejection' | 'ignoreFetchAbort' | 'allowStaleOnFetchAbort'> {
        /**
         * Set to true to force a re-load of the existing data, even if it
         * is not yet stale.
         */
     ...
     * `undefined` or `void`
     */
    interface MemoOptionsNoContext<K, V, FC extends undefined | void ***REMOVED*** undefined> extends MemoOptions<K, V, FC> {
        context?: FC;
    }
    /**
     * Options provided to the
     ...
     */
    interface MemoizerOptions<K, V, FC ***REMOVED*** unknown> {
     ...
     */
    interface MemoizerMemoOptions<K, V, FC ***REMOVED*** unknown> extends Pick<OptionsBase<K, V, FC>, 'allowStale' | 'updateAgeOnGet' | 'noDeleteOnStaleGet' | 'sizeCalculation' | 'ttl' | 'noDisposeOnSet' | 'noUpdateTTL'> {
        status?: Status<K, V, FC>;
        size?: Size;
        start?: Milliseconds;
    }
     ...
     */
    type Fetcher<K, V, FC ***REMOVED*** unknown> ***REMOVED*** (key: K, staleValue: V | undefined, options: FetcherOptions<K, V, FC>) ***REMOVED***> Promise<V | undefined | void> | V | undefined | void;
    /**
     * the type signature for the {@link OptionsBase.memoMethod} option.
     */
    type Memoizer<K, V, FC ***REMOVED*** unknown> ***REMOVED*** (key: K, staleValue: V | undefined, options: MemoizerOptions<K, V, FC>) ***REMOVED***> V;
    /**
    ...
    interface OptionsBase<K, V, FC> {
         ...
         *
         * ```ts
         * const cache ***REMOVED*** new LRUCache<string, any>({
         *   ttl: 100,
         *   fetchMethod: async (url, oldValue, { signal }) ***REMOVED***>  {
         *     const res ***REMOVED*** await fetch(url, { signal })
         *     return await res.json()
         *   }
         * })
         * cache.set('https://example.com/', { some: 'data' })
         * // 100ms go by...
         * const result ***REMOVED*** cache.fetch('https://example.com/')
         ...
         *     const res ***REMOVED*** await fetch(`https://slow-backend-server/${key}`)
         *     return await res.json()
         *   },
         * })
         *
         ...
         * const val ***REMOVED*** await c.fetch('key', { signal: AbortSignal.timeout(100) })
         * ```
         *
     ...
     */
    type Options<K, V, FC> ***REMOVED*** OptionsMaxLimit<K, V, FC> | OptionsSizeLimit<K, V, FC> | OptionsTTLLimit<K, V, FC>;
    /**
 ...
 */
export declare class LRUCache<K extends {}, V extends {}, FC ***REMOVED*** unknown> {
    #private;
    /**
     ...
     * @internal
     */
    static unsafeExposeInternals<K extends {}, V extends {}, FC extends unknown ***REMOVED*** unknown>(c: LRUCache<K, V, FC>): {
        ...
        readonly tail: Index;
        free: StackLike;
        isBackgroundFetch: (p: unknown) ***REMOVED***> p is BackgroundFetch<V>;
        backgroundFetch: (k: K, index: number | undefined, options: LRUCache.FetchOptions<K, V, FC>, context: unknown) ***REMOVED***> BackgroundFetch<V>;
        moveToTail: (index: number) ***REMOVED***> void;
        indexes: (options?: {
            allowStale: boolean;
        ...
        isStale: (index: number | undefined) ***REMOVED***> boolean;
    };
    /**
     ...
     */
    find(fn: (v: V, k: K, self: LRUCache<K, V, FC>) ***REMOVED***> boolean, getOptions?: LRUCache.GetOptions<K, V, FC>): V | undefined;
    /**
     ...
     */
    forEach(fn: (v: V, k: K, self: LRUCache<K, V, FC>) ***REMOVED***> unknown, thisp?: unknown): void;
    /**
     * The same as {@link LRUCache.forEach} but items are iterated over in
     * reverse order.  (ie, less recently used items are iterated over first.)
     */
    rforEach(fn: (v: V, k: K, self: LRUCache<K, V, FC>) ***REMOVED***> unknown, thisp?: unknown): void;
    /**
