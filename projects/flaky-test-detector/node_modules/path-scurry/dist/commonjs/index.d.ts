...
export interface FSOption {
    lstatSync?: (path: string) ***REMOVED***> Stats;
    readdir?: (path: string, options: {
        withFileTypes: true;
    }, cb: (er: NodeJS.ErrnoException | null, entries?: Dirent[]) ***REMOVED***> any) ***REMOVED***> void;
    readdirSync?: (path: string, options: {
        withFileTypes: true;
    }) ***REMOVED***> Dirent[];
    readlinkSync?: (path: string) ***REMOVED***> string;
    realpathSync?: (path: string) ***REMOVED***> string;
    promises?: {
        lstat?: (path: string) ***REMOVED***> Promise<Stats>;
        readdir?: (path: string, options: {
            withFileTypes: true;
        }) ***REMOVED***> Promise<Dirent[]>;
        readlink?: (path: string) ***REMOVED***> Promise<string>;
        realpath?: (path: string) ***REMOVED***> Promise<string>;
        [k: string]: any;
    };
    [k: string]: any;
}
...
export type Type ***REMOVED*** 'Unknown' | 'FIFO' | 'CharacterDevice' | 'Directory' | 'BlockDevice' | 'File' | 'SymbolicLink' | 'Socket';
/**
 ...
 * @internal
 */
export type Children ***REMOVED*** PathBase[] & {
    provisional: number;
};
...
export declare abstract class PathBase implements Dirent {
     ...
     */
    readdirCB(cb: (er: NodeJS.ErrnoException | null, entries: PathBase[]) ***REMOVED***> any, allowZalgo?: boolean): void;
    /**
    ...
    canReaddir(): boolean;
    shouldWalk(dirs: Set<PathBase | undefined>, walkFilter?: (e: PathBase) ***REMOVED***> boolean): boolean;
    /**
...
export interface WalkOptions {
     ...
     */
    filter?: (entry: PathBase) ***REMOVED***> boolean;
    /**
     ...
     * Asynchronous functions are not supported here.
     */
    walkFilter?: (entry: PathBase) ***REMOVED***> boolean;
}
export type WalkOptionsWithFileTypesUnset ***REMOVED*** WalkOptions & {
    withFileTypes?: undefined;
};
export type WalkOptionsWithFileTypesTrue ***REMOVED*** WalkOptions & {
    withFileTypes: true;
};
export type WalkOptionsWithFileTypesFalse ***REMOVED*** WalkOptions & {
    withFileTypes: false;
};
/**
...
export type Path ***REMOVED*** PathBase | InstanceType<typeof Path>;
/**
...
export type PathScurry ***REMOVED*** PathScurryBase | InstanceType<typeof PathScurry>;
export {};
